...
# 'data\\企业列表.xls'
def dealOneExcelFile(excelFileName):
  # 定原始excel文件路径
  # excelpath=excelpath
  #pcklfile='C:\\Users\\VI\\Desktop\\result.txt'
  # 'data\\'
  excelFileName = os.path.join('data\\', excelFileName)
...
def main():
  ...
  path = 'C:\\Users\\VI\\Documents\\GitHub\\Python-Deal-with-keyboardandMouse\\data'
